package model.command.core.converter;
...
public class CodeConverter {
	...
	/*
	 * Metodos principales, convierten las instrucciones en valores numéricos,
	 * dependiendo del metodo que se utilize TransformCodeOperatorLevel, ó
	...
	//
	// /*
	// * Función que retorna el valor de la categoria de un operador, es
	// invocada
	...
	// identifica
	// * como constante numérica o variable. Este método sólo se utiliza para
